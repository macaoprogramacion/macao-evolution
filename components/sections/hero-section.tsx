...
const sideImages = [
  {
    src: "/images/hero-secction/hero-seccion%20(1).png",
    alt: "Hero sección imagen 1",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-secction/hero-seccion%20(2).png",
    alt: "Hero sección imagen 2",
    position: "left",
    span: 1,
  },
  {
    src: "/images/hero-secction/hero-seccion%20(3).png",
    alt: "Hero sección imagen 3",
    position: "right",
    span: 1,
  },
  {
    src: "/images/hero-secction/hero-seccion%20(4).png",
      ...
      <div className="sticky top-0 h-screen overflow-hidden">
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              <Image
                src="/images/foto-con-dimecion-arreglada/foto-principal..png"
