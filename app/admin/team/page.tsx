...
export default function TeamPage() {
  const [teamMembers, setTeamMembers] = useState<TeamMember[]>([
    {
      ...
      email: "carlos.martinez@jonathanarache.com",
      avatar: "",
      status: "active",
      joinDate: "2025-01-15",
    },
    {
      ...
      email: "ana.rodriguez@jonathanarache.com",
      avatar: "",
      status: "active",
      joinDate: "2025-02-01",
    },
    {
      ...
      email: "pedro.garcia@jonathanarache.com",
      avatar: "",
      status: "active",
      joinDate: "2025-01-20",
    },
    {
      ...
      email: "maria.lopez@jonathanarache.com",
      avatar: "",
      status: "active",
      joinDate: "2025-01-10",
    },
    {
      ...
      email: "luis.fernandez@jonathanarache.com",
      avatar: "",
      status: "active",
      joinDate: "2025-02-05",
    },
  ...
  const handleCreateUser = () => {
    ...
    const newMember: TeamMember = {
      ...
      email: `${formData.name.toLowerCase().replace(/\s+/g, ".")}@jonathanarache.com`,
      avatar: "",
      status: "active",
