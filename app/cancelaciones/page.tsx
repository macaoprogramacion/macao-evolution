  ...
  return (
    ...
    >
      <article className="rounded-xl border border-border bg-card p-5 text-sm leading-7 text-foreground/90 shadow-sm md:p-8 md:text-base">
        ...
        <h2 className="mt-6 text-lg font-title text-foreground md:text-xl">2. Cambios de fecha</h2>
        <p className="mt-2">
        ...
        <h2 className="mt-6 text-lg font-title text-foreground md:text-xl">3. No show</h2>
        <p className="mt-2">
          En caso de no presentación sin aviso previo, la reserva podrá considerarse utilizada y no aplicará reembolso.
        </p>

        <h2 className="mt-6 text-lg font-title text-foreground md:text-xl">4. Cancelaciones por clima o seguridad</h2>
        <p className="mt-2">
        ...
        <h2 className="mt-6 text-lg font-title text-foreground md:text-xl">5. Contacto oficial</h2>
        <p className="mt-2">
