...
// Max file size for uploads (50MB — Supabase free tier limit)
...
export async function uploadFileToStorage(file, folder = 'photos', onProgress) {
  ...
  if (processedFile.size > MAX_FILE_SIZE) {
    throw new Error(`Archivo muy grande (${(processedFile.size / 1024 / 1024).toFixed(1)}MB). Máximo: ${MAX_FILE_SIZE / 1024 / 1024}MB`);
  }
