-- ╔══════════════════════════════════════════════════════════════════════════╗
-- ║  MIGRACIÓN: Seed de productos en tabla products                        ║
-- ║  Ejecutar en SQL Editor de Supabase                                    ║
-- ║  Nota: La tabla products ya debe existir (supabase-schema.sql)         ║
-- ╚══════════════════════════════════════════════════════════════════════════╝

-- Si la tabla aún no existe, descomenta las siguientes líneas:
...
-- ─── PRODUCTO 1: Elite Couple Experience ──────────────────────────────────
...
-- ─── PRODUCTO 2: Elite Family Experience ──────────────────────────────────
INSERT INTO products (slug, title, description, capacity, image, price, original_price, has_discount, discount_percent, duration, highlights, gallery, itinerary, general_info, category, website, website_label, website_color, active)
VALUES (
  ...
  '["/images/productos/producto%20(4).webp", "/images/Buggies/buggie%20(2).webp", "/images/Buggies/buggie%20(4).webp", "/images/paradas/columna%20(3).webp", "/images/paradas/columna%20(4).webp"]',
  '[{"title":"Pick-Up & City Tour","duration":"1.5 hrs","description":"Begin your adventure with a scenic city tour in an open-air Safari truck. Enjoy panoramic views of Punta Cana''s vibrant streets and lush landscapes as you head to the ranch base—no stops, just great sights."},{"title":"Ranch Base Briefing","duration":"30 mins","description":"Get geared up with safety instructions and helmet fitting before your buggy adventure. Our team ensures you''re confident and ready to ride."},{"title":"Typical Dominican House Visit","duration":"20 mins","description":"Experience authentic local culture in a peaceful rural setting.","details":["Coffee, Cocoa & Tobacco — Explore the roots of traditional farming and savor authentic local products."]},{"title":"Macao Beach Stop","duration":"20 mins","description":"Ride your buggy to the stunning Macao Beach, known for its white sands, turquoise waters, and peaceful vibe—perfect for relaxing or snapping photos."},{"title":"Cueva Taína — Cenote Cave","duration":"20 mins","description":"Explore a jungle cenote with crystal-clear waters and mystical cave formations.","details":["Swim in the refreshing natural pool."]},{"title":"Buggy Adventure","duration":"65 mins driving","description":"Drive through muddy trails, jungle paths, and open roads for an exciting 65-minute buggy experience. Every splash and turn adds to the thrill!"}]',
  '{"minAge":"Children must be 4 years old or above to participate, and drivers must be 18 years old or older.","notAllowed":"Pregnant women, individuals with heart conditions, mobility impairments, or under the influence of alcohol or drugs are not permitted to participate in the tour.","freeCancellation":"Cancel up to 24 hours in advance and receive a full refund.","bookNowPayLater":"Reserve your spot immediately with just $20 USD and pay the rest amount when you get to our base.","duration":"4 hours","guide":"English, French, Portuguese, Spanish, Italian, German, Russian","pickupService":"Pickup is available from hotels in Punta Cana, Bávaro, Uvero Alto, and Cabeza de Toro. Pickup time is typically 1-1.5 hours before the tour start time. You will be emailed the pickup location and time within 24 hours of booking. Please contact us the day before your tour if the information provided is unclear. Please wait outside the hotel 5 minutes before the pickup time, as the bus cannot park and wait."}',
  'Elite',
  'macaooffroad',
  'Macao Off Road',
...
-- ─── PRODUCTO 4: Predatory Family Experience ──────────────────────────────
INSERT INTO products (slug, title, description, capacity, image, price, original_price, has_discount, discount_percent, duration, highlights, gallery, itinerary, general_info, category, website, website_label, website_color, active)
VALUES (
...
VALUES (
  ...
  '["/images/productos/producto%20(5).webp", "/images/Buggies/buggie%20(9).webp", "/images/Buggies/buggie%20(10).webp", "/images/paradas/columna%20(1).webp", "/images/paradas/columna%20(3).webp"]',
...
VALUES (
  ...
  '["/images/productos/producto%20(6).webp", "/images/Buggies/buggie%20(1).webp", "/images/Buggies/buggie%20(5).webp", "/images/paradas/columna%20(2).webp", "/images/paradas/columna%20(4).webp"]',
  '[{"title":"Pick-Up & City Tour","duration":"1.5 hrs","description":"Begin your adventure with a scenic city tour in an open-air Safari truck."},{"title":"Ranch Base Briefing","duration":"30 mins","description":"Safety instructions and helmet fitting before your buggy adventure."},{"title":"Typical Dominican House Visit","duration":"20 mins","description":"Experience authentic local culture in a peaceful rural setting.","details":["Coffee, Cocoa & Tobacco — Explore the roots of traditional farming."]},{"title":"Macao Beach Stop","duration":"20 mins","description":"Ride your buggy to the stunning Macao Beach."},{"title":"Cueva Taína — Cenote Cave","duration":"20 mins","description":"Explore a jungle cenote with crystal-clear waters.","details":["Swim in the refreshing natural pool."]},{"title":"Buggy Adventure","duration":"65 mins driving","description":"Drive through muddy trails, jungle paths, and open roads."}]',
  '{"minAge":"Children must be 4 years old or above to participate, and drivers must be 18 years old or older.","notAllowed":"Pregnant women, individuals with heart conditions, mobility impairments, or under the influence of alcohol or drugs are not permitted to participate in the tour.","freeCancellation":"Cancel up to 24 hours in advance and receive a full refund.","bookNowPayLater":"Reserve your spot immediately with just $20 USD and pay the rest amount when you get to our base.","duration":"4 hours","guide":"English, French, Portuguese, Spanish, Italian, German, Russian","pickupService":"Pickup is available from hotels in Punta Cana, Bávaro, Uvero Alto, and Cabeza de Toro."}',
  'Nature',
  'saonaisland',
...
VALUES (
  ...
  '["/images/productos/producto%20(7).webp", "/images/Buggies/buggie%20(3).webp", "/images/Buggies/buggie%20(6).webp", "/images/paradas/columna%20(1).webp", "/images/paradas/columna%20(2).webp"]',
...
VALUES (
  ...
  '["/images/productos/producto%20(8).webp", "/images/Buggies/buggie%20(4).webp", "/images/Buggies/buggie%20(7).webp", "/images/paradas/columna%20(3).webp", "/images/paradas/columna%20(4).webp"]',
...
VALUES (
  ...
  '["/images/productos/producto%20(9).webp", "/images/Buggies/buggie%20(8).webp", "/images/Buggies/buggie%20(2).webp", "/images/paradas/columna%20(1).webp", "/images/paradas/columna%20(4).webp"]',
...
-- Permitir lectura pública (para la web)
